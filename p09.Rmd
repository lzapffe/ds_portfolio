...
Since the data contains confidential information, I will attach a link to the html output in the portfolio repository like I have done for several of the other applied projects.

<br>

**You can find the html file for the semi-automatic scoring of the challenge  [here](https://github.com/lzapffe/ds_portfolio/blob/main/score-completion.html)**
