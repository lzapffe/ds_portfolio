...
-   I pertain the right to switch or switch out any of the modules and labs with another module or lab in the course from what is currently specified in the contract. This will not affect the number of labs or modules that are to be completed according to the contract. This can be
