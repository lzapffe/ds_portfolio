...
Used the cheatsheet at this resource: https://hypebright.nl/en/r-en/ultimate-cheatsheet-for-regex-in-r-2/
...
- To match an even number of characters, you can use "^(?:..)+$"
...
## General advise not fitting other sections

- Be as specific as you can and add contrast whenever you can
  - E.g. "^\D+\d{3}$" this regex will be more efficient than "^.+\d{3}$" for matching three letters and three digits
- Likewise, always be as specific as you can be
...
I finished the 15 regex crosswords at [regexcrosswords.com](https://regexcrossword.com/) to get some practice with the regex. I also used regex is several of my applied projects to easily change column names, find relevant columns, and naming columns. It has saved me a lot of time so far, especially when working with bigger data sets, such as the Parenting Across Cultures data set that I worked on for two of my projects.
...
Things I didn't look further into, but could be future areas:
- [PCRE callouts](https://www.rexegg.com/pcre-callouts.php)
...
- You can actually use explosive quantifiers to ReDoS attack a webpage by giving a regex that will have it run a very large number of variation, to eventually slow down or shut down a webpage - https://en.wikipedia.org/wiki/ReDoS